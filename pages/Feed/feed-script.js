...
const newComment = new Comment(123, 456, 'kasjkasjl');
Functions.setLocalStorage('comments', newComment);

const newCommentCard = new CommentCard();

newCommentCard.renderCommentCard();
